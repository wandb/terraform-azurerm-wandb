...
| <a name="input_kube_audit_retention_in_days"></a> [kube\_audit\_retention\_in\_days](#input\_kube\_audit\_retention\_in\_days) | Retention in days for the AKS audit Log Analytics workspace when one is created by this module. | `number` | `90` | no |
